        ...
        <section className="glass-card rounded-2xl p-6 space-y-4 opacity-0 animate-fade-up" style={{ animationDelay: '300ms', animationFillMode: 'forwards' }}>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 rounded-xl border border-[var(--border)] bg-[var(--glass-bg)] hover:bg-[var(--border)] px-5 py-3 text-sm font-medium transition-all duration-200"
            >
        ...
        <section className="glass-card rounded-2xl p-6 space-y-5 opacity-0 animate-fade-up" style={{ animationDelay: '350ms', animationFillMode: 'forwards' }}>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <pre className="rounded-xl bg-[var(--bg-card)] border border-[var(--border)] px-4 py-3 text-xs font-mono text-emerald-400 overflow-x-auto whitespace-pre-wrap break-all">
                {badgeMarkdown}
              </pre>
              <button
                onClick={() => copyToClipboard(badgeMarkdown, 'markdown')}
                className="absolute top-2 right-2 rounded-lg border border-[var(--border)] bg-[var(--glass-bg)] hover:bg-[var(--border)] px-2.5 py-1 text-xs transition-all"
              >
                    ...
                    <div className="shrink-0 text-right flex flex-col items-end gap-1.5">
                      ...
                      {reached && (
                        <a
                          ...
                          className="inline-flex items-center gap-1 rounded-lg border border-[var(--border)] bg-[var(--glass-bg)] hover:bg-[var(--border)] px-2 py-1 text-[10px] text-[var(--text-secondary)] transition-colors"
