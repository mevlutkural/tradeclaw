        ...
        <div className="pt-12 pb-8 text-center">
          ...
          >
            <div
              ...
              style={{ background: countdown <= 5 ? '#10b981' : 'var(--border)', transition: 'background 0.3s' }}
            />
            Next refresh in <span style={{ color: 'var(--foreground)', fontVariantNumeric: 'tabular-nums' }}>{countdown}s</span>
            &nbsp;· Tick #{tick}
          </div>
        </div>
