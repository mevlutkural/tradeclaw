    ...
    <button
      ...
      className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all duration-200 ${
        copied
          ...
          : 'bg-[var(--glass-bg)] hover:bg-[var(--border)] text-[var(--text-secondary)] hover:text-[var(--foreground)] border border-[var(--border)]'
      }`}
    >
      {copied ? (
        <>
  ...
  return (
    <div className="border border-[var(--border)] rounded-xl overflow-hidden">
      <button
        ...
        className="w-full flex items-center justify-between gap-4 px-5 py-4 text-left hover:bg-[var(--glass-bg)] transition-colors"
      >
    ...
    <main className="min-h-screen bg-[var(--background)] text-[var(--foreground)]">
      ...
      <section className="relative px-6 pt-28 pb-20 text-center overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-6xl font-bold tracking-tight mb-4 leading-tight text-[var(--foreground)]">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 mb-10">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 px-6 py-3 rounded-full bg-[var(--glass-bg)] hover:bg-[var(--border)] text-[var(--foreground)] text-sm font-medium transition-colors border border-[var(--border)]"
            >
        ...
        <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-3xl p-8">
          ...
          <div className="mb-8">
            ...
            <div className="space-y-3">
              {TAGLINES.map((t, i) => (
                <div key={i} className="flex items-center justify-between gap-4 bg-[var(--glass-bg)] border border-[var(--border)] rounded-xl px-4 py-3">
          ...
          <div className="mb-8">
            ...
            <div className="bg-[var(--glass-bg)] border border-[var(--border)] rounded-xl p-4">
          ...
          <div className="mb-8">
            ...
            <div className="flex flex-wrap gap-2">
              {TOPICS.map((t) => (
                <span key={t} className="px-3 py-1.5 rounded-full text-xs font-medium bg-[var(--glass-bg)] border border-[var(--border)] text-[var(--foreground)]">
                  {t}
                </span>
              ))}
            </div>
          ...
          <div className="mb-8">
            ...
            <div className="bg-[var(--glass-bg)] border border-[var(--border)] rounded-xl p-4 max-h-48 overflow-y-auto">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {GALLERY_SUGGESTIONS.map((g, i) => (
                <div key={i} className="flex gap-3 p-3 rounded-xl bg-[var(--glass-bg)] border border-[var(--border)]">
      ...
      <section className="px-6 pb-20 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 gap-4">
          {TWEETS.map((t) => (
            <div key={t.platform} className="bg-[var(--bg-card)] border border-[var(--border)] rounded-2xl p-5">
              ...
              <pre className="text-xs text-[var(--text-secondary)] leading-relaxed whitespace-pre-wrap font-sans bg-[var(--glass-bg)] rounded-xl p-3 max-h-40 overflow-y-auto">
                {t.text}
              </pre>
            </div>
          ))}
