      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
                  ...
                  {broker.connected ? (
                    ...
                    <div className="flex gap-1">
                      <button
                        ...
                        className="text-[10px] text-[var(--text-secondary)] hover:text-emerald-500 px-2 py-1 rounded border border-transparent hover:border-emerald-500/20 transition-colors"
                      >
                        Reconnect
                      </button>
                      <button
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                ...
                className="text-[10px] text-[var(--text-secondary)] hover:text-emerald-500 px-3 py-1.5 rounded-lg border border-[var(--border)] hover:border-emerald-500/20 transition-colors disabled:opacity-50"
              >
        ...
        <div className="mt-8 glass-card p-5">
          ...
          <ol className="flex flex-col gap-2 text-xs text-[var(--text-secondary)]">
            ...
            <li><span className="text-[var(--foreground)]/80 font-semibold">5.</span> Your token is proxied through <span className="text-[var(--foreground)]/80 font-mono">/api/broker</span> server-side — it never leaves the server in production</li>
          </ol>
        </div>
      </div>
    </div>
